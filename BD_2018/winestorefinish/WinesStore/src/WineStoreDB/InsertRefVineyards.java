...
public class InsertRefVineyards extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 249, -1));
        ...
        getContentPane().add(okButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(294, 131, -1, -1));
        ...
        getContentPane().add(cancelButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(393, 131, -1, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 27, -1, -1));
        ...
        if (text.isEmpty()) {
            ...
            try {
                if (validacionDatos(text) > 0) {
                    ...
                    int input = JOptionPane.showConfirmDialog(rootPane, "¿Está seguro de agregar el viñedo " + text + "?", "Agregar viñedo", 0);
                    if (input == 0) {
                        StringBuilder sql
